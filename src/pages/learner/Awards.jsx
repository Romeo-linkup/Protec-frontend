...
export default function LearnerAwards() {
  ...
  return (
    <div className="view">
      ...
      {myRecord && (
        <div className="card" style={{ background:'var(--blue-bg)', border:'0.5px solid var(--blue-border)' }}>
                ...
                <div style={{ flex:1 }}>
                  <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                    <div className="award-name">
                      {x.full_name} {x.learner_id === user?.learnerId && <span style={{fontSize:'10px',color:'var(--blue-text)'}}>(you)</span>}
                    </div>
